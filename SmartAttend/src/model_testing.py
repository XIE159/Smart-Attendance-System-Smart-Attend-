...
model = f'{model_2}.pkl'
detection_model_path = os.path.normpath(r'C:\Users\Student\SmartAttend\classes\testclass2\models')
detection_model_path = os.path.join(detection_model_path, model)
encoder_path = os.path.normpath(r'C:\Users\Student\SmartAttend\classes\testclass2\models\label_encoder.pkl')
detection_model = load_caffe_model(r'C:\Users\Student\A.I-09\ICAT_2_testing_4\models\model_2\deploy.prototxt', 
                             r'C:\Users\Student\A.I-09\ICAT_2_testing_4\models\model_2\res10_300x300_ssd_iter_140000.caffemodel')
